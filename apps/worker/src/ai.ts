// Minimal self-contained DeepSeek client for worker actions (score_lead, compose_email).
// Mirrors apps/web/lib/ai.ts — the worker runs standalone on Railway and cannot
// import from the Next.js web app.
